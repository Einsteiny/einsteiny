...
public class ExploreCourseGridAdapter extends RecyclerView.Adapter<ExploreCourseGridAdapter.CourseViewHolder> {
...
//        TextView tvDescription;
    ...
    public ExploreCourseGridAdapter(Context context, List<Course> courses) {
    ...
    public CourseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View topicView = inflater.inflate(R.layout.item_topic_grid, parent, false);
